...
class GlobalPlanner:
    ...
    def show_path(self):
        """..."""
        img = Image.fromarray(self.map.cropped).convert("RGB")
...
if __name__ == "__main__":
    ...
    planner = GlobalPlanner(_map, (20.192, 1.347), 0, (33, 24.3))
    # planner = GlobalPlanner(_map, (1.192, 1.347), 0, (33, 24.3))
